...
def activate(input_id, 
             basic_cards, social_cards, tab_cards, basic_boxes, value_boxes, gallery_1, tab_gallery_2):
...
def activate_page_content(basic_cards, social_cards, tab_cards, basic_boxes, value_boxes, gallery_1, tab_gallery_2):
...
def update_breadcrumbs( nClick1, nClick2, nClick3, nClick4, nClick5, nClick6, nClick7,
    basic_cards, social_cards, tab_cards, basic_boxes, value_boxes, gallery_1, gallery_2): 
